...
public class SpringServiceImpl implements SpringService {
	...
	private final Logger logger = Logger.getLogger(SpringServiceImpl.class);
	 ...
	 * the Spring context for the Super Simple Stocks application.
	 */
	 ...
	 * {@link SpringServiceHolder} is loaded on the first execution of
	 * {@link SpringServiceImpl#getInstance()} or the first access to
	 * {@link SpringServiceHolder#INSTANCE}, not before.
	 */
